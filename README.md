...
## 🔒 Projects I can talk about but can't show you

Some of my favourite work lives behind a private repo — either built for clients as freelance work, or shared with collaborators who'd rather I didn't publish their source. Happy to walk through any of these; the code stays put, but the war stories travel.
...
**Nilo** — A smartwatch to help parents care for children with ADHD. Contracted to take it from idea to first working prototype: a watch app in JavaScript on an open wearable platform, a Python/FastAPI service behind it, and a TypeScript React PWA for the parent-facing side. All of it was built with Claude — and I mean all of it. The design, the watch app, the service, the PWA. Three runtimes, one wrist, and a collaborator with no opinions about whose turn it was to write the tests. 🕺

---

## 🛠 What I mostly work in

Python (services, orchestration, concurrency, CLIs) · TypeScript/React · C/C++ and embedded · LLM inference serving, RAG, agentic workflows, evals · Spark/Databricks · AWS
